...
#define ATL2_MCP_HOST_REQ_INT_ADR 0x0F00
#define ATL2_MCP_HOST_REQ_INT_SET_ADR 0x0F04
#define ATL2_MCP_HOST_REQ_INT_CLR_ADR 0x0F08
#define ATL2_MIF_SHARED_BUFFER_IN_ADR(dword) (0x00012000 + (dword) * 0x4)
#define ATL2_MIF_SHARED_BUFFER_OUT_ADR(dword) (0x00013000 + (dword) * 0x4)
#define ATL2_MIF_HOST_FINISHED_WRITE_ADR 0x0e00u
#define ATL2_MIF_HOST_FINISHED_WRITE_MSK 0x00000001u
#define ATL2_MIF_HOST_FINISHED_WRITE_SHIFT 0
#define ATL2_MIF_HOST_FINISHED_WRITE_WIDTH 1
#define ATL2_MIF_MCP_FINISHED_READ_ADR 0x0e04u
#define ATL2_MIF_MCP_FINISHED_READ_MSK 0x00000001u
#define ATL2_MIF_MCP_FINISHED_READ_SHIFT 0
#define ATL2_MIF_MCP_FINISHED_READ_WIDTH 1
